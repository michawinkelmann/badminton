...
export const animDriveVh: BewegungsAnimation = {
  ...
  shuttleBahn: [
    ...bezierBahn({ x: 98, y: 33 }, { x: 89.05, y: 37.23 }, { x: 81.1, y: 42.45 }, 350, 800, 8, { von: 10, bis: 13 }),
    ...bezierBahn( { x: 81.1, y: 42.45 }, { x: 89.05, y: 34.23 }, { x: 98, y: 31 }, 800, 1200, 8, { von: 13, bis: 9 }),
  ],
}
